     ...
     /* constructor */function(options){
         if(options && !(options.timer || {}).enable){ return; }
             this.on('render', function(){
                 ...
                 * @name magic.Calendar.$timer#getDate
                 * @function
                 * @grammar magic.Calendar.$timer#getDate()
                 * @example
                 * var instance = new magic.Calendar({
                 *      weekStart: 'sat',
                 *      initDate: new Date()
                 ...
                 * @name magic.Calendar.$timer#setDate
                 * @function
                 * @grammar magic.Calendar.$timer#setDate(date)
                 * @param {Date} date 日期
                 * @example
                 * var instance = new magic.Calendar({
                 *      weekStart: 'sat',
                 ...
                 * 选中前一小时
                 */
                me._preHour = function(){
                    var me = this,
                        h = me._hms[0],
                        value = h.value;
                    h.value = fillZero(--value < 0 ? 0 : value); 
                };
                /**
                 * 选中后一小时
                 */
                me._nextHour = function(){
                    var me = this,
                        h = me._hms[0],
                        value = h.value;
                    h.value = fillZero(++value > 23 ? 23 : value);
                };

                /**
                 * 选中前一分钟
                 */
                me._preMinute = function(){
                    var me = this,
                        m = me._hms[1],
                        value = m.value;
                    m.value = fillZero(--value < 0 ? 0 : value);
                };
                /**
                 * 选中后一分钟
                 */
                me._nextMinute = function(){
                    var me = this,
                        m = me._hms[1],
                        value = m.value;
                    m.value = fillZero(++value > 59 ? 59 : value);
                };

                /**
                 * 选中前一秒
                 */
                me._preSecond = function(){
                    var me = this,
                        s = me._hms[2],
                        value = s.value;
                    s.value = fillZero(--value < 0 ? 0 : value);
                };
                /**
                 * 选中后一秒
                 */
                me._nextSecond = function(){
                    var me = this,
                        s = me._hms[2],
                        value = s.value;
                    s.value = fillZero(++value > 59 ? 59 : value);
                };
                
                /**
                 * 触发选中时间日期事件
                 */
                me._fireSelectedDate = function(){
